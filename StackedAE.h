...
private:
    ...
    void SGD_updateParameters(MatrixXd &theta1Grad,MatrixXd &theta2Grad,MatrixXd &b1Grad,MatrixXd &b2Grad,MatrixXd &softmaxThetaGrad,double alpha);
    void ADA_updateParameters(MatrixXd &theta1Grad,MatrixXd &theta2Grad,MatrixXd &b1Grad,MatrixXd &b2Grad,MatrixXd &softmaxThetaGrad,double alpha);
    ...
    double NAG_computeCost(MatrixXd &theta1Grad,MatrixXd &b1Grad,MatrixXd &theta2Grad,MatrixXd &b2Grad,MatrixXd &softmaxThetaGrad,MatrixXd &data,MatrixXi &labels,double lambda);
public:
